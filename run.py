...
def set_log(args):
    log_file_path = f'logs/{args.modelName}-{args.datasetName}-ours_ablation.log'
    # set logging
...
def parse_args():
    ...
    parser.add_argument('--modelName', type=str, default='sugrm',
                        help='support sugrm')
...
def seed(s):
    if isinstance(s, int):
        ...
        seed_list = []
        for i in range(5):
            seed_list.append(random.randint(0, 9999))
        return seed_list
    else:
        raise argparse.ArgumentTypeError(
